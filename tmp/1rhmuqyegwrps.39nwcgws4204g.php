...
<div class="container" style="margin-bottom: 50px">
	...
	<form method="post" action="">
		<div class="row">
			...
			<div class="col">
				<p><strong>Aisle# </strong><?= ($vhs['location']) ?> - <strong>Qty</strong> <?= ($vhs['inventory']) ?></p>
			</div>
			<div class="col">
				<p><?= ($vhs['rental']) ?></p>
			</div>
		...
		<div class="row">
			...
			<div class="col">
				<p><strong>Aisle# </strong> <?= ($dvd['location']) ?> - <strong>Qty</strong> <?= ($dvd['inventory']) ?></p>
			</div>
			<div class="col">
				<p><?= ($dvd['rental']) ?></p>
			</div>
		...
		<div class="row">
			...
			<div class="col">
				<p><strong>Aisle# </strong> <?= ($bluray['location']) ?> - <strong>Qty</strong> <?= ($bluray['inventory']) ?></p>
			</div>
			<div class="col">
				<p><?= ($bluray['rental']) ?></p>
			</div>
